...
from tvb.core.services.projectservice import ProjectService, PROJECTS_PAGE_SIZE
...
from tvb.core.entities.file.metadatahandler import XMLReader
...
from tvb_test.core.test_factory import TestFactory, ExtremeTestFactory
from tvb_test.datatypes import datatypes_factory
from tvb_test.datatypes.datatype1 import Datatype1
from tvb.core.entities.model import OperationGroup
...
#        self.clean_database()
    ...
    def test_get_linkable_projects(self):
        ...
        result_meta = { DataTypeMetaData.KEY_OPERATION_TYPE: "Upload",
    ...
    def __check_meta_data(self, expected_meta_data, new_datatype):
        """Validate Meta-Data"""
        mapp_keys = { DataTypeMetaData.KEY_SUBJECT: "subject",
        ...
        for key, value in expected_meta_data.iteritems():
            if key in mapp_keys:
                ...
                if DataTypeMetaData.KEY_OP_GROUP_ID in expected_meta_data:
                    ...
                    op_group = dao.get_generic_entity(OperationGroup, op_group)[0]
