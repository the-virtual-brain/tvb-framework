...
from tvb.core.services.projectservice import initialize_storage, ProjectService
...
class OperationServiceTest(BaseTestCase):
    ...
    def test_initiate_operation(self):
        ...
        group = dao.find_group(module, class_name)
        self.assertEqual(group.module, 'tvb_test.adapters.testadapter1', "Wrong data stored.")
