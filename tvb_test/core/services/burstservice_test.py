...
from tvb.core.services.burstservice import BurstService, KEY_SAVED_VALUE, KEY_PARAMETER_CHECKED
...
from tvb.core.portlets.portlet_XML_reader import KEY_DYNAMIC
...
class BurstServiceTest(BaseTestCase):
    ...
    def test_build_portlet_interface(self):
        ...
        #from tvb_test/core/portlets/test_portlet.xml
    ...
    def test_getavailablebursts_none(self):
        ...
        self.assertEqual(bursts, [], "Unexpected result returned : %s" % (bursts,))
    ...
    def test_launch_burst(self):
        ...
        first_step_algo, first_step_algo_group = self.flow_service.get_algorithm_by_module_and_class(
            'tvb_test.adapters.testadapter1', 'TestAdapter1')
    ...
    def test_launch_burst_invalid_simulator_parameters(self):
        ...
        """
        algo_id = self.flow_service.get_algorithm_by_module_and_class('tvb_test.adapters.testadapter1',
                                                                      'TestAdapter1')[0].id
    ...
    def _prepare_and_launch_sync_burst(self):
        ...
        operations, group = self.operation_service.prepare_operations(self.test_user.id, self.test_project.id,
                                                                      ...
                                                                      metadata, **kwargs)
        view_step = TestFactory.create_workflow_step("tvb_test.adapters.testadapter2", "TestAdapter2",
...
def suite():
    ...
    test_suite.addTest(unittest.makeSuite(BurstServiceTest))
    return test_suite
