...
class SurfaceH5(H5File):
    ...
    def __init__(self, path):
        ...
        self.vertices = DataSet(Surface.vertices)
        self.triangles = DataSet(Surface.triangles)
        self.vertex_normals = DataSet(Surface.vertex_normals)
        self.triangle_normals = DataSet(Surface.triangle_normals)
        self.number_of_vertices = Scalar(Surface.number_of_vertices)
        self.number_of_triangles = Scalar(Surface.number_of_triangles)
        self.edge_mean_length = Scalar(Surface.edge_mean_length)
        self.edge_min_length = Scalar(Surface.edge_min_length)
        self.edge_max_length = Scalar(Surface.edge_max_length)
        self.zero_based_triangles = Scalar(Surface.zero_based_triangles)
        self.split_triangles = DataSet(Surface.split_triangles)
        self.number_of_split_slices = Scalar(Surface.number_of_split_slices)
        self.split_slices = Json(Surface.split_slices)
        self.bi_hemispheric = Scalar(Surface.bi_hemispheric)
        self.surface_type = Scalar(Surface.surface_type)
        self.valid_for_simulations = Scalar(Surface.valid_for_simulations)
