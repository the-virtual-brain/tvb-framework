...
(function ($) {
	...
	$(function () {
		...
		var MIN_W = "300px";
		var css_string = '' + 
			'#vakata-contextmenu { display:block; visibility:hidden; left:0; top:-200px; position:absolute; margin:0; padding:0; min-width:'+MIN_W+'; background:#ebebeb; border:1px solid silver; z-index:10000; *width:'+WIDTH+' } ' + 
			'#vakata-contextmenu ul { min-width:'+MIN_W+'; *width:'+WIDTH+'; } ' + 
			...
			'#vakata-contextmenu .bottom { top:-5px; top:auto; } ' + 
